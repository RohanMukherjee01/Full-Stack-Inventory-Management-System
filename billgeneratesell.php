...
table, th, td {
  ...
  border-collapse: collapse;
    ...
    <body onload="window.print();">
        ...
        $tta=0;
    $bill=$_GET['b'];
   $q="select * from finalsell where billno='$bill'";
        ...
        <table style="width:100%">
            ...
            <tr>
                <td >Seller Name---
                    <br>
                    <?php 
                     $q1="select * from sell where billno='$bill'";
                     $res8 = mysqli_query($con, $q1);
                     $row8 = mysqli_fetch_assoc($res8);
                     echo $row8['customername'];
                     ?>
                     <br>
                     Phone Number---
                     <br>
                     <!-- echo $row8['customerphno'];
                    echo $row8['customeraddress']; -->
                    <?php 
                     $q1="select * from sell where billno='$bill'";
                     $res8 = mysqli_query($con, $q1);
                     $row8 = mysqli_fetch_assoc($res8);
            ...
            <tr>
                <td>
                <?php $qdes="select * from finalsell where billno='$bill'";
...
?>
                ...
                <td><?php $qdes="select * from finalsell where billno='$bill'";
    $resdes = mysqli_query($con, $qdes);
...
?></td>
    ...
    ?></td>
            ...
            <tr>
                <td colspan="5" style="padding-right:150px"> <p align="right">total Tax amount: <?php echo $ta+$tta;?></p></td>
            </tr>    
            <tr>
